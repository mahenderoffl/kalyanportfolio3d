...
export default function LifeAtIITKharagpurPage() {
  return (
            ...
            <GlassCard className="p-8 md:p-12 mb-8">
              ...
              <section className="mb-12">
                ...
                <p className="text-lg text-[var(--text-secondary)] mb-6 leading-relaxed">
                  <strong className="text-[var(--accent-orange)]">IIT Kharagpur</strong> is the first and largest of the IITs
                  established by the Government of India in 1951. Located in West Bengal, it is widely recognized as
                  one of the premier technical institutes globally, known for its illustrious alumni, cutting-edge
                  research, and vibrant campus culture.
                </p>

                <p className="text-lg text-[var(--text-secondary)] mb-6 leading-relaxed">
                  Being part of this historic institution has been an honor. The massive campus, spread across
                  2100 acres, offers unparalleled opportunities for academic growth and extracurricular exploration.
                </p>
              </section>
